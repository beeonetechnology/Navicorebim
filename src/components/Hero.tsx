                ...
                <div className="relative z-10 container mx-auto px-5 text-center text-white">
                  <div className="max-w-4xl mx-auto">
                    <h1 className="  font-bold mb-6 animate-hero-title pt-16 pb--4">
                      <span className=" text-4xl md:text-5xl lg:text-6xl xl:text-8xl block animate-slide-in-left animate-delay-100">
                        {slide.title}
                      </span>
                      <span className=" text-4xl md:text-5xl lg:text-6xl xl:text-8xl block text-[#6ddcf5] animate-slide-in-right animate-delay-300">
                        {slide.subtitle}
                      </span>
                    </h1>
