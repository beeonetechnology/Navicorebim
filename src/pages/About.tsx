    ...
    <div className="min-h-screen pt-0">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 bg-gradient-primary bg-clip-text text-[#6ddcf5] text-center">
          <h1 className="text-5xl font-bold mb-6 animate-slide-up pt-10">
            About NavicoreBIM
          </h1>
...
<div className="mt-12 animate-slide-up">
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
    ...
    <div className="order-2 lg:order-1 pr-10">
      <h2 className="text-xl font-bold bg-gradient-primary bg-clip-text text-transparent mb-6 text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
      {values.map((value, index) => (
        ...
        >
          ...
          <p className="text-gray-600 text-l">{value.description}</p>
        </div>
      ))}
    </div>
  </div>
