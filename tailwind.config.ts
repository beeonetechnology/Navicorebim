  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "stagger-slide": "stagger-slide 1s ease-out",
        "hero-title": "hero-title 1.2s cubic-bezier(0.16, 1, 0.3, 1)",
        "parallax-slow": "parallax-slow 20s linear infinite",
        "carousel-slide": "carousel-slide 1s cubic-bezier(0.4, 0, 0.2, 1)",
        "carousel-fade": "carousel-fade 0.8s ease-out",
      },
    },
  },
